// "use strict";
var kks=document.getElementsByTagName("body")[0];
kks.addEventListener('DOMContentLoaded',function(){
  alert("loaded");
});
...
document.addEventListener('click',function(button){
  ...
  //---Clear Tag---------------------------------
    ...
    // console.log(button.target.parentNode);
      ...
      FillArea(button.target);console.log(SiteArea.parentNode);
    ...
    if(prev){
      prev.style.backgroundColor="rgb(128, 128, 128,0.4)";
      prev.setAttribute("check","0");
      ClearArea(SiteArea);console.log(SiteArea.parentNode);
  ...
  else if(button.target.parentNode.getAttribute("check")=="0"){
      if(prev){
        prev.style.backgroundColor="rgb(128, 128, 128,0.4)";
        prev.setAttribute("check","0");
        ClearArea(SiteArea);
      }
      button.target.parentNode.setAttribute("check","1");
      button.target.parentNode.style.backgroundColor= "rgba(127, 133, 133, 0.822)"; 
      // button.target.style.backgroundColor= "rgb(128, 128, 128,0.8)"; 
      FillArea(button.target.parentNode);console.log(SiteArea.parentNode);

      prev=button.target.parentNode; 
  }
  else if(button.target.parentNode.getAttribute("check")=="1"){
    if(prev){
      prev.style.backgroundColor="rgb(128, 128, 128,0.4)";
      prev.setAttribute("check","0");
      ClearArea(SiteArea);console.log(SiteArea.parentNode);
    ...
    button.target.parentNode.style.backgroundColor= "rgb(128, 128, 128,0.4)";
    button.target.parentNode.setAttribute("check","0");
  }
});

//-------------------Fill_the_Site_Area---------------------------------
function FillArea(button){
  SiteArea.parentNode.style.visibility = "visible";
  var dispSite="";
...
function ClearArea(SiteArea){
  SiteArea.parentNode.style.visibility = "hidden";
  SiteArea.innerHTML="";
};
